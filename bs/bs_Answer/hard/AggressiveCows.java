...
public class AggressiveCows {
    // Brute Force
    public static int findMaxMinDist(int[] arr, int cows) {
        // Brute Force
        // Arrays.sort(arr);
        // int result = 0;
        // int maxDist = arr[arr.length - 1] - arr[0];
        // for (int i = 1; i <= maxDist; i++) {
        //     if(arrangeCows(arr, cows, i)) {
        //         result = i;
        //     }else {
        //         break;
        //     }
    ...
    static boolean arrangeCows(int[] arr, int cows, int dist) {
        int i = 1, last = arr[0];
        cows--;
